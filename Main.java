...
public class Main {
    public static void main(String args[]) throws FileNotFoundException {
        ...
        for (ArrayList<ArrayList<String>> all: data){
            for(ArrayList<String> type: all){
...
//        Variable var1 = new Variable("proj_funding", true, 0, 100);
//        Variable var2 = new Variable("exp_level", true, 0, 60);
//        Variable var3 = new Variable("risk", false, 0, 100);
//
